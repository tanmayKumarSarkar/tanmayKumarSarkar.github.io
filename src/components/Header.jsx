  ...
  return (
    ...
    >
      <div className="w-full px-5 md:px-3 lg:px-10 xl:px-15 flex flex-wrap items-center justify-between mx-auto py-2">
        ...
        <div
          className="hiddens w-full md:flex md:w-auto md:justify-end"
          id="navbar-default"
        >
          ...
          <ul className="font-medium flex flex-row md:flex-row rounded-lg bg-transparent justify-center md:justify-end flex-wrap">
            {navRoutes.map((nav) => (
              <li key={nav.id}>
                <a
                  href={nav.path}
                  className="flex px-2 mx-[2px] mb-1 text-white bg-transparent md:bg-transparent md:hover:bg-blue-700 rounded md:rounded-full md:px-2 md:py-2 shadow-sm hover:
hover:shadow-white"
                  //   aria-current="page"
                >
                  {nav.title}
