        ...
        <div>
          ...
          <ul className="text-left text-sm mt-2">
            <li>
              ...
              of candidates because your time is limited. With Aeromexico,
              invite as many as candidates as you wish. Include all your 'may
              be' candidates for video screening. You are likely to find some
              gems there.
            </li>
            <li>
