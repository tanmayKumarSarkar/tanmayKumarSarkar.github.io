...
const PeekHire = ({ project }) => {
  return (
    <div>
      <div className="PeekHire-wrapper project-wrapper">
        <div>
          ...
          <ul className="text-left text-sm mt-2">
            <li>
              ...
              of candidates because your time is limited. With PeekHire, invite
              as many as candidates as you wish. Include all your 'may be'
